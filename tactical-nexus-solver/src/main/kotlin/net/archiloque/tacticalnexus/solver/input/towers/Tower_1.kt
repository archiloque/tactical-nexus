...
public class Tower_1 : Tower {
  private val fighters: Array<Enemy?> = arrayOf(null, Enemy(EnemyType.fighter, 1, 120, 55, 25, 2,
      Items.guard_piece), null, Enemy(EnemyType.fighter, 3, 320, 110, 40, 5, Items.guard_piece),
  ...
  private val rangers: Array<Enemy?> = arrayOf(null, null, Enemy(EnemyType.ranger, 2, 200, 200, 10,
      4, Items.red_potion), null, Enemy(EnemyType.ranger, 4, 200, 350, 20, 16, Items.red_potion),
  ...
  private val levels: Array<Level> = arrayOf(Level(11, 15, arrayOf(arrayOf(null, null, null, null,
      null, null, null, Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      null, null, null, ), arrayOf(null, null, null, null, null, null, Wall.instance,
      Items.guard_gem, Items.guard_potion, Items.guard_gem, rangers[2], null, Wall.instance, null,
      null, ), arrayOf(null, null, null, null, null, Wall.instance, Items.power_piece,
      Wall.instance, Items.guard_gem, Wall.instance, null, Wall.instance, Items.red_potion,
      Wall.instance, null, ), arrayOf(null, null, null, null, Wall.instance, Items.power_piece,
      Items.power_gem, Items.power_piece, fighters[3], null, Items.power_gem, fighters[1],
      Items.life_potion, Items.red_potion, Wall.instance, ), arrayOf(Wall.instance, Wall.instance,
      ...
      Wall.instance, ), arrayOf(null, PlayerStartPosition.instance, null, Items.power_gem,
      ...
      Staircase.up, ), arrayOf(Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      Wall.instance, Wall.instance, Items.guard_piece, Wall.instance, Items.blue_potion,
      Wall.instance, null, Wall.instance, rangers[4], Wall.instance, Wall.instance, ), arrayOf(null,
      ...
      Wall.instance, ), arrayOf(null, null, null, null, null, Wall.instance, Items.guard_piece,
      Wall.instance, null, Wall.instance, null, Wall.instance, Items.red_potion, Wall.instance,
      null, ), arrayOf(null, null, null, null, null, null, Wall.instance, null, Items.power_potion,
      null, rangers[2], null, Wall.instance, null, null, ), arrayOf(null, null, null, null, null,
      null, null, Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance, null,
      null, null, ), )), Level(15, 15, arrayOf(arrayOf(Items.guard_deck, Wall.instance, null,
      ...
      arrayOf(fighters[8], Wall.instance, Items.guard_piece, Items.power_gem, Items.guard_piece,
      ...
      arrayOf(Key(KeyOrDoorColor.yellow), Wall.instance, null, Items.guard_piece, fighters[3],
      Items.blue_potion, null, null, fighters[3], null, Items.power_gem, Items.life_potion, null,
      rangers[2], Wall.instance, ), arrayOf(fighters[8], null, Items.heavenly_potion, null,
      ...
      arrayOf(null, Items.power_potion, null, Wall.instance, Wall.instance, Items.life_potion,
      ...
      arrayOf(null, null, rangers[4], Items.power_potion, Wall.instance, Items.power_potion,
      Items.heavenly_potion, Wall.instance, null, Wall.instance, Items.guard_potion,
      Items.guard_gem, Wall.instance, fighters[1], Wall.instance, ), arrayOf(Wall.instance,
      ...
      Wall.instance, ), arrayOf(Staircase.up, Items.drop_of_dream_ocean, fighters[5], null,
      fighters[3], Items.power_gem, null, null, fighters[3], null, Items.life_potion, rangers[2],
      null, Items.heavenly_potion, Staircase.down, ), arrayOf(Wall.instance, Wall.instance, null,
      ...
      arrayOf(null, null, rangers[4], Items.guard_potion, Wall.instance, Items.power_potion,
      Items.power_gem, Wall.instance, null, Wall.instance, Items.guard_card, Items.guard_potion,
      Wall.instance, fighters[1], Wall.instance, ), arrayOf(null, Items.guard_potion, null,
      ...
      Items.guard_card, Wall.instance, Items.guard_potion, Wall.instance, ), arrayOf(fighters[8],
      ...
      Items.blue_potion, Wall.instance, ), arrayOf(Key(KeyOrDoorColor.blue), Wall.instance, null,
      Items.power_piece, fighters[3], Items.blue_potion, null, null, rangers[4], null,
      Items.power_gem, Items.life_potion, null, rangers[2], Wall.instance, ), arrayOf(rangers[22],
      Wall.instance, Items.power_piece, Items.guard_gem, Items.power_piece, Wall.instance,
      Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      Wall.instance, Wall.instance, Wall.instance, ), arrayOf(Items.life_crown, Wall.instance, null,
      Items.power_piece, null, rangers[7], null, Items.life_potion, null, rangers[10], null,
      Items.heavenly_potion, null, rangers[13], Key(KeyOrDoorColor.blue), ), )), Level(15, 15,
      arrayOf(arrayOf(Items.life_crown, Items.golden_feather, Door(KeyOrDoorColor.violet),
      ...
      arrayOf(Items.drop_of_dream_ocean, Wall.instance, Items.power_potion, fighters[5],
      ...
      ), arrayOf(Wall.instance, Wall.instance, Wall.instance, fighters[5], Wall.instance,
      ...
      rangers[13], ), arrayOf(Door(KeyOrDoorColor.crimson), Wall.instance, fighters[5],
      ...
      Door(KeyOrDoorColor.yellow), null, Items.guard_potion, null, ), arrayOf(Wall.instance,
      ...
      Items.blue_potion, ), arrayOf(Items.power_gem, rangers[7], Items.power_gem, rangers[7],
      ...
      Key(KeyOrDoorColor.yellow), Items.life_crown, fighters[19], ), )), Level(15, 15,
      arrayOf(arrayOf(null, null, Items.blue_potion, null, null, Wall.instance, null, null, null,
      Wall.instance, null, null, null, null, null, ), arrayOf(null, Items.guard_potion,
      ...
      null, null, null, null, Staircase.down, null, Staircase.up, ), arrayOf(null, null, null, null,
      null, null, null, null, null, null, null, null, null, null, null, ), arrayOf(Wall.instance,
      Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance, null, null, null,
      Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance, ),
      arrayOf(null, null, Items.red_potion, null, null, Wall.instance, null, null, null,
      Wall.instance, null, null, Items.power_piece, null, null, ), arrayOf(null, Items.power_potion,
      ...
      null, null, ), )), Level(15, 15, arrayOf(arrayOf(Items.heavenly_potion,
      ...
      arrayOf(Exit.instance, Items.drop_of_dream_ocean, Door(KeyOrDoorColor.crimson),
