...
public class Tower_1 : Tower {
  ...
  private val standardLevels: Array<TowerLevel> = arrayOf(TowerLevel(arrayOf(arrayOf(null, null,
      ...
      Wall.instance, Wall.instance, Wall.instance, null, Wall.instance, ), arrayOf(Staircase.up,
      ...
      rangers[13], Key(KeyOrDoorColor.blue), ), )), TowerLevel(arrayOf(arrayOf(Items.life_crown,
      ...
      Items.guard_potion, Items.power_potion, ), arrayOf(Items.drop_of_dream_ocean, Wall.instance,
      ...
      Items.power_potion, Items.guard_potion, ), arrayOf(Wall.instance, Wall.instance,
      ...
      Door(KeyOrDoorColor.blue), Door(KeyOrDoorColor.yellow), ), arrayOf(Items.golden_feather,
      ...
      Items.power_potion, rangers[13], ), arrayOf(Door(KeyOrDoorColor.crimson), Wall.instance,
      ...
      Items.blue_potion, ), arrayOf(Items.heavenly_potion, fighters[8], fighters[5], null,
      Wall.instance, Items.power_gem, null, Wall.instance, null, null, Wall.instance,
      Door(KeyOrDoorColor.yellow), fighters[5], Items.guard_potion, null, ), arrayOf(Wall.instance,
      ...
      Items.life_potion, Wall.instance, rangers[13], rangers[7], ), arrayOf(Staircase.down, null,
      null, null, Items.power_potion, null, null, fighters[12], null, rangers[7], Items.life_potion,
      fighters[8], Staircase.up, Wall.instance, rangers[10], ), arrayOf(Wall.instance,
      ...
      fighters[8], ), arrayOf(rangers[7], null, Items.power_gem, Items.heavenly_potion,
      ...
      arrayOf(Items.power_gem, rangers[7], null, Items.power_gem, Wall.instance, rangers[4],
      fighters[3], null, fighters[5], Items.heavenly_potion, fighters[8], fighters[12],
      Items.blue_potion, Items.life_potion, Items.blue_potion, ), arrayOf(rangers[7],
      Items.power_gem, Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      null, null, fighters[5], null, Wall.instance, Items.blue_potion, Items.heavenly_potion,
      Items.blue_potion, ), arrayOf(Items.power_gem, rangers[7], Items.power_gem, fighters[5],
      ...
      arrayOf(rangers[7], Items.power_gem, rangers[7], Items.power_gem, Wall.instance,
      ...
      arrayOf(Key(KeyOrDoorColor.yellow), rangers[7], Items.power_gem, rangers[7],
      ...
      TowerLevel(arrayOf(arrayOf(null, null, Items.blue_potion, null, null, Wall.instance, null,
      null, null, Wall.instance, null, null, null, null, null, ), arrayOf(null, Items.guard_potion,
      Items.guard_card, Items.guard_potion, null, Wall.instance, null, null, null, Wall.instance,
      null, null, Items.heavenly_potion, null, null, ), arrayOf(Items.blue_potion, Items.guard_card,
      ...
      Items.heavenly_potion, null, ), arrayOf(null, Items.guard_potion, Items.guard_card,
      Items.guard_potion, null, Wall.instance, null, null, null, Wall.instance, null, null,
      Items.heavenly_potion, null, null, ), arrayOf(null, null, Items.blue_potion, null, null,
      ...
      Wall.instance, Wall.instance, ), arrayOf(null, null, null, null, null, null, null, null, null,
      null, null, null, null, null, null, ), arrayOf(null, null, null, null, null, null, null,
      ...
      null, ), arrayOf(Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      Wall.instance, null, null, null, Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      Wall.instance, Wall.instance, ), arrayOf(null, null, Items.red_potion, null, null,
      Wall.instance, null, null, null, Wall.instance, null, null, Items.power_piece, null, null, ),
      arrayOf(null, Items.power_potion, Items.power_card, Items.power_potion, null, Wall.instance,
      null, null, null, Wall.instance, null, Items.guard_piece, Items.drop_of_dream_ocean,
      Items.guard_piece, null, ), arrayOf(Items.red_potion, Items.power_card, Items.power_deck,
      ...
      Items.drop_of_dream_ocean, Items.power_piece, ), arrayOf(null, Items.power_potion,
      Items.power_card, Items.power_potion, null, Wall.instance, null, null, null, Wall.instance,
      null, Items.guard_piece, Items.drop_of_dream_ocean, Items.guard_piece, null, ), arrayOf(null,
      null, Items.red_potion, null, null, Wall.instance, null, null, null, Wall.instance, null,
      null, Items.power_piece, null, null, ), )), TowerLevel(arrayOf(arrayOf(Items.heavenly_potion,
      ...
      Door(KeyOrDoorColor.crimson), Key(KeyOrDoorColor.violet), ), arrayOf(Items.heavenly_potion,
      ...
      arrayOf(Items.heavenly_potion, Wall.instance, Items.guard_deck, Items.guard_card, rangers[18],
      Wall.instance, null, fighters[15], Items.power_potion, Items.power_card, Items.power_potion,
      fighters[15], null, Wall.instance, Items.life_crown, ), arrayOf(Items.heavenly_potion,
      ...
      Wall.instance, fighters[19], ), arrayOf(rangers[22], Wall.instance, fighters[19],
      ...
      arrayOf(rangers[22], Items.power_deck, Items.power_card, Wall.instance, Items.power_card,
      fighters[15], Items.heavenly_potion, null, Wall.instance, Wall.instance, Wall.instance, null,
      Items.heavenly_potion, fighters[15], fighters[15], ), arrayOf(Wall.instance, Wall.instance,
      ...
      arrayOf(Staircase.up, Items.drop_of_dream_ocean, Door(KeyOrDoorColor.crimson),
      ...
      Staircase.down, ), arrayOf(Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      Wall.instance, Wall.instance, Wall.instance, fighters[15], null, Items.power_card, null,
      fighters[15], Wall.instance, Wall.instance, Wall.instance, ), arrayOf(Items.heavenly_potion,
      ...
      Wall.instance, Items.golden_feather, ), arrayOf(Items.heavenly_potion, rangers[22],
      ...
      Wall.instance, rangers[26], ), arrayOf(Items.heavenly_potion, Wall.instance, Items.guard_gem,
      ...
      Door(KeyOrDoorColor.blue), Wall.instance, ), arrayOf(Wall.instance, rangers[13], rangers[13],
      ...
      arrayOf(Items.power_card, Wall.instance, rangers[13], Wall.instance, rangers[16],
      ...
      arrayOf(Items.heavenly_potion, fighters[19], null, null, Items.guard_potion, Wall.instance,
      ...
      arrayOf(Items.heavenly_potion, Wall.instance, fighters[12], Wall.instance, fighters[15],
      ...
      Wall.instance, ), arrayOf(Items.heavenly_potion, Wall.instance, fighters[12], Wall.instance,
      ...
      Items.drop_of_dream_ocean, Items.drop_of_dream_ocean, ), arrayOf(Wall.instance, fighters[12],
      ...
      arrayOf(Wall.instance, Door(KeyOrDoorColor.crimson), fighters[12], Wall.instance,
  ...
  private val nexusLevels: Array<TowerLevel> = arrayOf(TowerLevel(arrayOf(arrayOf(null, null, null,
      ...
      arrayOf(Staircase.up, burgeoners[16], null, null, null, null, null, null, null, null, null,
      null, null, null, null, ), )), TowerLevel(arrayOf(arrayOf(null, null, null, null, null, null,
      null, null, null, null, null, null, null, null, null, ), arrayOf(null, null, null, null, null,
      ...
      null, null, null, null, null, null, ), arrayOf(null, null, null, null, null, null, null, null,
      null, null, null, null, null, null, null, ), arrayOf(null, null, null, null, null, null, null,
      null, null, null, null, null, null, null, null, ), arrayOf(Staircase.down, null, null, null,
