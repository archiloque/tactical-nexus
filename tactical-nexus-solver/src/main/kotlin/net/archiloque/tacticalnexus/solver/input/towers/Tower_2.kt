...
public class Tower_2 : Tower {
  ...
  private val standardLevels: Array<TowerLevel> = arrayOf(TowerLevel(arrayOf(arrayOf(null, null,
      ...
      null, null, null, ), arrayOf(null, null, null, null, null, null, null, null, null, null,
      Items.heavenly_potion, null, null, null, null, ), arrayOf(null, null, null, null, null, null,
      ...
      null, null, null, Staircase.up, null, null, null, null, null, null, null, ), arrayOf(null,
      null, null, null, null, null, null, null, null, null, null, null, null, null, null, ),
      arrayOf(null, null, null, null, null, null, null, null, null, null, null, null, null, null,
      null, ), arrayOf(null, null, null, null, null, null, null, null, null, null, null, null, null,
      null, null, ), arrayOf(null, null, null, null, null, null, null, null, null, null, null, null,
      ...
      null, null, null, null, null, ), )), TowerLevel(arrayOf(arrayOf(Key(KeyOrDoorColor.yellow),
      ...
      Items.golden_feather, ), arrayOf(Items.power_gem, Wall.instance, Items.power_gem,
      ...
      arrayOf(enemies[23], null, null, enemies[3], Wall.instance, enemies[3], null,
      Items.blue_potion, null, Wall.instance, Key(KeyOrDoorColor.yellow), Items.red_potion,
      Wall.instance, Key(KeyOrDoorColor.yellow), Items.guard_card, ), arrayOf(Items.guard_gem, null,
      ...
      Items.power_potion, enemies[17], enemies[3], ), arrayOf(Items.life_crown, Wall.instance,
      ...
      Items.guard_potion, null, ), arrayOf(Key(KeyOrDoorColor.greenblue), Wall.instance,
      ...
      enemies[3], ), )), TowerLevel(arrayOf(arrayOf(Key(KeyOrDoorColor.yellow), Items.guard_piece,
      ...
      Wall.instance, Door(KeyOrDoorColor.yellow), ), arrayOf(Wall.instance, Wall.instance,
      ...
      arrayOf(Items.heavenly_potion, Items.heavenly_potion, Door(KeyOrDoorColor.crimson),
      ...
      enemies[0], ), arrayOf(Wall.instance, Wall.instance, Wall.instance, enemies[18], enemies[17],
      null, null, null, enemies[4], null, null, Wall.instance, Wall.instance, Wall.instance,
      Wall.instance, ), arrayOf(Items.life_potion, Door(KeyOrDoorColor.blue), Items.power_potion,
      ...
      Items.guard_deck, ), arrayOf(Wall.instance, Wall.instance, Wall.instance, enemies[18], null,
      ...
      ), arrayOf(Wall.instance, Wall.instance, Wall.instance, null, enemies[10], Items.power_gem,
      Wall.instance, Wall.instance, null, Items.power_gem, enemies[24], Wall.instance,
      Wall.instance, Wall.instance, Wall.instance, ), arrayOf(Items.guard_gem, enemies[23], null,
      ...
      ), arrayOf(enemies[3], null, enemies[3], null, enemies[9], null, Door(KeyOrDoorColor.blue),
      Items.guard_gem, enemies[18], enemies[23], null, Wall.instance, enemies[24], Wall.instance,
      enemies[14], ), arrayOf(null, enemies[3], Wall.instance, Wall.instance, Wall.instance,
      enemies[0], Wall.instance, Wall.instance, Wall.instance, enemies[23], Wall.instance,
      Wall.instance, enemies[24], Wall.instance, enemies[7], ), arrayOf(enemies[23], null,
      ...
      TowerLevel(arrayOf(arrayOf(Items.blue_potion, Key(KeyOrDoorColor.blue),
      ...
      Items.power_potion, ), arrayOf(Key(KeyOrDoorColor.yellow), Key(KeyOrDoorColor.crimson),
      ...
      arrayOf(Key(KeyOrDoorColor.blue), Items.power_card, Items.heavenly_potion,
      ...
      Items.guard_potion, Items.power_potion, ), arrayOf(Items.life_potion,
      ...
      arrayOf(Wall.instance, Wall.instance, Wall.instance, Wall.instance, Wall.instance, null,
      Items.power_gem, enemies[10], Items.power_gem, enemies[10], enemies[25], Items.guard_gem,
      enemies[4], enemies[15], Items.power_gem, ), arrayOf(Items.power_potion, Items.guard_potion,
      ...
      Items.power_gem, Items.guard_gem, ), arrayOf(Items.power_potion, enemies[24],
      ...
      Items.power_gem, Wall.instance, null, ), arrayOf(Wall.instance, Door(KeyOrDoorColor.yellow),
      ...
      arrayOf(Items.power_gem, Items.guard_gem, Door(KeyOrDoorColor.yellow), enemies[24],
      Items.power_potion, Wall.instance, null, enemies[24], null, Wall.instance, enemies[3],
      enemies[23], Wall.instance, Items.life_potion, Items.life_potion, ), arrayOf(Items.guard_gem,
      ...
      Wall.instance, ), arrayOf(Door(KeyOrDoorColor.yellow), Wall.instance, Items.life_potion,
      ...
      Items.power_potion, ), arrayOf(Items.power_piece, enemies[4], Door(KeyOrDoorColor.yellow),
      ...
      Wall.instance, enemies[25], ), arrayOf(Items.power_piece, Items.power_piece, Wall.instance,
      ...
      Items.red_potion, ), arrayOf(Wall.instance, Wall.instance, Items.power_card, Wall.instance,
      ...
      enemies[10], ), arrayOf(Key(KeyOrDoorColor.crimson), enemies[5], Door(KeyOrDoorColor.crimson),
      ...
      Items.blue_potion, ), )), TowerLevel(arrayOf(arrayOf(Key(KeyOrDoorColor.crimson),
      ...
      arrayOf(Items.power_potion, Key(KeyOrDoorColor.yellow), Items.power_potion, Wall.instance,
      ...
      Door(KeyOrDoorColor.yellow), ), arrayOf(Key(KeyOrDoorColor.yellow), Items.life_potion,
      ...
      Items.red_potion, Items.red_potion, enemies[18], ), arrayOf(Items.guard_potion,
      ...
      arrayOf(Key(KeyOrDoorColor.blue), Items.guard_potion, enemies[2],
      ...
      Wall.instance, Wall.instance, Door(KeyOrDoorColor.blue), ), arrayOf(Wall.instance,
      ...
      Items.blue_potion, enemies[11], Items.blue_potion, ), arrayOf(Key(KeyOrDoorColor.yellow),
      ...
      enemies[5], Items.blue_potion, enemies[19], ), arrayOf(enemies[5], Items.guard_piece,
      ...
      Wall.instance, Door(KeyOrDoorColor.blue), ), arrayOf(Items.guard_piece, Items.life_potion,
      ...
      Items.guard_piece, enemies[12], ), arrayOf(enemies[26], Wall.instance, Wall.instance,
      ...
      Items.life_potion, Items.guard_piece, ), arrayOf(Items.life_potion, enemies[26],
      ...
      Items.power_piece, Items.guard_piece, enemies[26], ), arrayOf(Items.life_potion, enemies[26],
      ...
      Wall.instance, Door(KeyOrDoorColor.crimson), ), arrayOf(enemies[26], Wall.instance,
      ...
      Items.life_potion, enemies[13], ), arrayOf(Items.power_potion, enemies[25],
      ...
      arrayOf(enemies[25], Items.power_potion, Door(KeyOrDoorColor.yellow),
      ...
      TowerLevel(arrayOf(arrayOf(Door(KeyOrDoorColor.yellow), Items.life_potion, Items.power_card,
      ...
      arrayOf(Items.life_potion, Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      ...
      Wall.instance, Items.life_potion, ), arrayOf(Items.life_potion, Wall.instance,
      ...
      Items.life_potion, ), arrayOf(Door(KeyOrDoorColor.yellow), Wall.instance, Wall.instance,
      ...
      arrayOf(Items.power_deck, enemies[27], enemies[11], Items.life_potion, enemies[11],
      ...
      arrayOf(Wall.instance, enemies[6], Wall.instance, enemies[26], Wall.instance, enemies[26],
      Wall.instance, enemies[26], Wall.instance, enemies[26], Wall.instance, enemies[12],
      Wall.instance, enemies[26], Wall.instance, ), arrayOf(Items.guard_piece, Items.blue_potion,
      ...
      Items.blue_potion, Items.power_gem, ), arrayOf(Wall.instance, enemies[5], Wall.instance,
      ...
      arrayOf(Items.guard_piece, Items.blue_potion, enemies[5], Door(KeyOrDoorColor.yellow),
      ...
      arrayOf(Wall.instance, enemies[5], Wall.instance, enemies[25], Wall.instance, enemies[5],
      Wall.instance, enemies[5], Wall.instance, enemies[4], Wall.instance, enemies[26],
      Wall.instance, enemies[26], Wall.instance, ), arrayOf(Items.guard_piece, Items.red_potion,
      ...
      Items.red_potion, Items.power_gem, ), arrayOf(Wall.instance, enemies[4], Wall.instance,
      ...
      arrayOf(Items.guard_piece, Items.red_potion, enemies[5], Items.red_potion, enemies[25],
      ...
      arrayOf(Items.guard_piece, Items.red_potion, null, Items.red_potion, enemies[25],
      ...
      TowerLevel(arrayOf(arrayOf(Items.power_piece, Items.power_piece, Items.power_piece,
      Items.power_piece, Items.power_piece, Items.power_piece, Items.power_piece, Items.power_piece,
      Items.power_piece, Items.power_piece, Items.power_piece, Items.power_piece, Items.power_piece,
      Items.power_piece, enemies[19], ), arrayOf(enemies[26], Wall.instance,
      ...
      arrayOf(Items.red_potion, Items.red_potion, enemies[26], Items.power_card, enemies[26],
      ...
      Items.guard_piece, ), arrayOf(Wall.instance, Wall.instance, Door(KeyOrDoorColor.yellow),
      ...
      Wall.instance, Items.guard_piece, ), arrayOf(Items.blue_potion, Items.red_potion, enemies[6],
      ...
      Door(KeyOrDoorColor.crimson), Items.guard_piece, ), arrayOf(enemies[26], Wall.instance,
      ...
      arrayOf(Items.blue_potion, Items.red_potion, enemies[11], Items.guard_gem, enemies[11],
      ...
      arrayOf(Wall.instance, Wall.instance, Door(KeyOrDoorColor.yellow), Wall.instance,
      ...
      Items.guard_piece, ), arrayOf(Items.blue_potion, Items.red_potion, enemies[18],
      ...
      Door(KeyOrDoorColor.violet), Items.guard_piece, ), arrayOf(enemies[26], Wall.instance,
      Door(KeyOrDoorColor.yellow), Wall.instance, Wall.instance, Wall.instance, Wall.instance,
      Door(KeyOrDoorColor.yellow), Wall.instance, Wall.instance, Wall.instance,
      Door(KeyOrDoorColor.yellow), Wall.instance, Wall.instance, Items.guard_piece, ),
      arrayOf(Items.blue_potion, Items.red_potion, enemies[11], Items.power_piece, enemies[11],
      ...
      Wall.instance, Items.guard_piece, ), arrayOf(Items.blue_potion, Items.red_potion, enemies[5],
      ...
      Items.guard_piece, ), arrayOf(enemies[26], Wall.instance, Door(KeyOrDoorColor.yellow),
      Wall.instance, Wall.instance, Wall.instance, Wall.instance, Door(KeyOrDoorColor.yellow),
      Wall.instance, Wall.instance, Wall.instance, Door(KeyOrDoorColor.yellow), Wall.instance,
      Key(KeyOrDoorColor.platinum), Wall.instance, ), arrayOf(Items.blue_potion, Items.red_potion,
      ...
      Door(KeyOrDoorColor.platinum), Staircase.up, ), )), TowerLevel(arrayOf(arrayOf(null, null,
      null, null, null, null, null, null, null, null, null, null, null, null, null, ), arrayOf(null,
      null, null, null, null, null, null, null, null, null, null, null, null, null, null, ),
      arrayOf(null, null, null, null, null, null, null, null, null, null, null, null, null, null,
      null, ), arrayOf(null, null, null, null, null, null, null, null, null, null, null, null, null,
      null, null, ), arrayOf(null, Items.guard_gem, Items.guard_gem, null, null, null, null, null,
      ...
      null, null, null, null, null, null, null, null, null, ), arrayOf(null, null, null, null, null,
      null, null, null, null, null, null, null, null, null, null, ), arrayOf(null, null, null,
