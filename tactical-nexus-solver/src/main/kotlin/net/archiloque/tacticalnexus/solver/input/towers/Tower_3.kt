...
public class Tower_3 : Tower {
  ...
  private val standardLevels: Array<TowerLevel> =
      arrayOf(TowerLevel(arrayOf(arrayOf(item_golden_feather, Wall.instance, item_life_crown,
      ...
      item_life_crown, ), arrayOf(enemies[7], enemies[19], enemies[19], enemies[42], enemies[31],
      enemies[47], enemies[22], enemies[11], enemies[46], enemies[23], enemies[32], Wall.instance,
      enemies[21], Wall.instance, enemies[45], ), arrayOf(enemies[43], enemies[43], enemies[42],
      ...
      arrayOf(enemies[19], enemies[18], enemies[30], enemies[31], item_heavenly_potion, enemies[45],
      enemies[22], item_drop_of_dream_ocean, enemies[22], enemies[21], enemies[45], Wall.instance,
      item_life_potion, Wall.instance, item_life_potion, ), arrayOf(enemies[18], enemies[30],
      ...
      arrayOf(item_life_crown, enemies[41], item_power_potion, enemies[13], item_guard_potion,
      enemies[26], item_red_potion, enemies[10], item_red_potion, enemies[25], Wall.instance,
      item_power_potion, enemies[8], enemies[14], item_life_potion, ), arrayOf(Wall.instance,
      ...
      Wall.instance, ), arrayOf(item_golden_feather, enemies[1], enemies[25], enemies[25],
      enemies[25], enemies[0], null, PlayerStartPosition.instance, null, enemies[1], enemies[26],
      item_blue_potion, enemies[15], enemies[2], item_golden_feather, ), arrayOf(Wall.instance,
      ...
      Wall.instance, ), arrayOf(enemies[4], item_life_potion, Wall.instance, Wall.instance,
      ...
      arrayOf(enemies[28], Wall.instance, enemies[17], enemies[17], item_heavenly_potion,
      Wall.instance, enemies[16], enemies[15], enemies[40], item_life_crown, enemies[43],
      enemies[19], enemies[31], enemies[19], Wall.instance, ), arrayOf(enemies[28], Wall.instance,
      ...
      item_golden_feather, ), arrayOf(enemies[40], Wall.instance, item_golden_feather,
      ...
      ), arrayOf(enemies[40], Wall.instance, Wall.instance, enemies[29], item_heavenly_potion,
      enemies[18], enemies[40], enemies[4], enemies[40], enemies[42], enemies[43], enemies[32],
      enemies[33], enemies[20], enemies[35], ), arrayOf(enemies[16], enemies[16], item_life_potion,
