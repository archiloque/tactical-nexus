...
class GoodiesGroupTest {
    ...
    fun calculation() {
        ...
        assertEquals(createGroup(Items.golden_feather, Items.golden_feather).item.expMultAdd, 60)
        assertEquals(createGroup(Items.life_crown, Items.life_crown).item.hpMultAdd, 60)
